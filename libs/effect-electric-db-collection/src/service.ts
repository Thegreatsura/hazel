 ...
 *
 * This factory uses `Context.Service` instead of `Effect.Service` because collection
...
export const ElectricCollection = <T extends Row<unknown>, TKey extends string | number = string | number>(
	id: string,
): Context.Service<ElectricCollectionService<T, TKey>, ElectricCollectionService<T, TKey>> =>
	Context.Service<ElectricCollectionService<T, TKey>>(`ElectricCollection<${id}>`)
