...
export const TextEditorLink = ({ className }: { className?: string }) => {
    ...
    return (
        <EditorButton aria-label="Link ⌘K" isDisabled={isDisabled} isActive={editor.isActive("link")} onClick={setLink} className={className}>
    ...
    return (
        <DialogTrigger>
            <Tooltip title="Text color">
                <EditorButton aria-label="Text color" isDisabled={isDisabled} isActive={editor.isActive("underline")} className={className}>
                    <div
                        style={{
