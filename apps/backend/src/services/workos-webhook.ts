...
export class WebhookTimestampError extends Schema.TaggedErrorClass<WebhookTimestampError>(
...
export class WorkOSWebhookVerifier extends ServiceMap.Service<WorkOSWebhookVerifier>()(
