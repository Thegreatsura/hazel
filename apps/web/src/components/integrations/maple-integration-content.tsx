				...
				{configuredChannels.length === 0 && !newlyCreatedWebhook ? (
					<div className="flex flex-col items-center justify-center px-5 py-12 text-center">
						<div className="mb-4 flex size-16 items-center justify-center rounded-lg bg-secondary/50">
							<img src={getProviderIconUrl("maple")} alt="Maple" className="size-8 rounded" />
						</div>
								...
								<div className="flex items-start gap-3">
									...
									<div className="flex-1 space-y-3">
										...
										<div className="flex gap-2">
											<Input
												value={`${import.meta.env.VITE_BACKEND_URL}/webhooks/incoming/${newlyCreatedWebhook.webhookId}/${newlyCreatedWebhook.token}/maple`}
												readOnly
