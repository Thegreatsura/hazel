...
type CodeComponent = Component<JSX.IntrinsicElements["code"] & SolidMarkdownProps & { inline?: boolean }>
type HeadingComponent = Component<JSX.IntrinsicElements["h1"] & SolidMarkdownProps & { level: number }>
