...
export function getElementsBeforeCount(parent: Element | Root, node?: Element): number {
	let index = -1
	let count = 0
...
export function addProperty(props: Record<string, unknown>, prop: string, value: unknown, ctx: Context) {
